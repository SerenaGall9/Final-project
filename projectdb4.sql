...
--
-- Host: localhost    Database: projectdb4
-- ------------------------------------------------------
...
INSERT INTO `review` VALUES (9,3,2,4,4,5,4,4,'Nice food, but the shisha wasn\'t as enjoyable as expected. Still a good place for drinks.','2012-06-15'),(10,4,2,5,5,5,5,5,'Great spot for a gathering with friends. Lovely outdoor seating area!','2017-08-23'),(11,5,2,4,5,4,4,5,'Good place to relax, with lovely appetizers, but the main course could have been better.','2011-01-09'),(12,6,2,3,4,3,5,4,'Great vibe, but it was a bit overpriced for what you get.','2014-09-30'),(13,7,3,5,5,5,4,4,'Perfect protein-packed meals after a workout. Excellent options for anyone looking to eat clean!','2019-10-04'),(14,8,3,3,4,3,5,3,'The food is decent, but the atmosphere is a bit too loud for me.','2018-11-22'),(15,9,3,4,5,5,4,5,'Love the healthy options and the quick service. Great for lunch breaks!','2020-03-15'),(16,10,3,4,4,4,5,4,'Decent food, but could have been a bit more flavorful.','2017-02-01'),(17,11,4,4,5,4,5,5,'Cozy and charming. Pasta was fantastic, but it can get crowded during weekends.','2013-07-18'),(18,12,4,5,5,5,5,5,'The best pasta in town! Great for a casual night out.','2015-02-10'),(19,13,4,4,5,3,4,4,'Good pasta, but could have been more flavorful. The wine selection was great though.','2022-06-23'),(20,14,4,5,5,4,5,4,'Nice for a cozy dinner. Great for dates!','2019-11-16'),(21,15,5,5,5,5,5,4,'Fantastic atmosphere and great food. The lamb was cooked to perfection.','2020-02-17'),(22,1,5,4,4,3,4,4,'The food was good but the service could have been faster. Still a lovely place for a meal.','2019-05-06'),(23,2,5,3,3,3,3,3,'Nice setting, but the food was not up to par for the price.','2016-08-30'),(24,3,5,5,5,4,5,5,'A fantastic meal and very warm atmosphere. Highly recommend!','2021-04-10'),(25,4,6,5,5,4,5,5,'A true taste of Italy. Loved the tiramisu!','2021-07-23'),(26,5,6,4,5,5,4,4,'Impressive wine list and lovely staff, though the mains were a little pricey.','2017-12-01'),(27,6,6,4,5,5,3,3,'Great wine selection, but I was underwhelmed by the main course.','2022-04-05'),(28,7,6,5,4,5,5,5,'Felt like I was in Italy! Great pasta dishes and wine.','2020-08-15'),(29,8,7,5,5,5,4,4,'Perfect date night spot. Great food and cozy atmosphere.','2016-03-12'),(30,9,7,4,4,5,4,3,'Good food, but the noise levels made it hard to relax. Still enjoyed the experience.','2021-09-10'),(31,10,7,3,4,4,5,3,'Not a fan of the noise, but the pizza was pretty good.','2022-05-04'),(32,11,7,5,5,5,5,5,'Best pizza and pasta combo in the area. Perfect for casual dining.','2023-01-28'),(33,12,8,4,4,5,5,5,'Delicious Indian food and very attentive service. Will return soon.','2014-06-11'),(34,13,8,5,5,5,5,4,'Wonderful food and exceptional service. The tasting menu was amazing!','2019-03-27'),(35,14,8,4,5,4,5,5,'Sophisticated restaurant with a great menu. Perfect for special occasions.','2021-08-18'),(36,15,8,5,5,5,5,5,'The most amazing Indian food I\'ve had. The tasting menu is a must-try.','2023-06-11'),(37,1,9,4,4,4,5,5,'Great vibe, but I found the curry a bit too spicy for my taste.','2020-11-06'),(38,2,9,5,5,5,5,5,'Love the decor, and the food is top notch. Definitely worth the wait.','2021-01-13'),(39,3,9,5,5,4,5,5,'Incredible vibe and fantastic food. Worth every penny!','2022-03-21'),(40,4,9,3,4,3,4,4,'The food was decent, but I found the service a bit slow.','2019-07-12'),(41,5,10,4,5,4,5,4,'Good food, though the flavors weren\'t as bold as I expected.','2012-07-23'),(42,6,10,5,5,5,5,5,'Opulent and flavorful. The service was impeccable, and the dishes were unforgettable!','2023-11-30'),(43,7,10,4,4,4,4,4,'Nice place, but the menu could have been a little more varied.','2020-09-17'),(44,8,10,5,5,5,5,5,'Incredible dining experience. Highly recommend the game dishes.','2021-12-03'),(45,9,11,4,4,4,5,3,'The grilled meats were great, but I wasn\'t impressed with the sides.','2015-09-03'),(46,10,11,5,5,5,5,4,'Fantastic Lebanese food, and the atmosphere is perfect for a night out.','2018-04-19'),(47,11,11,4,5,4,4,4,'Great value for money. The meats were perfectly grilled, but the service was a bit slow.','2020-07-30'),(48,12,11,5,5,5,4,5,'Top-notch Lebanese food and amazing service. Would definitely return!','2022-10-10'),(49,13,12,5,5,4,5,5,'The mezze was fantastic and fresh. Definitely recommend the shawarma!','2013-02-25'),(50,14,12,4,4,4,4,3,'Food was good, but the service was a bit slow during peak hours.','2016-11-12'),(51,15,12,4,5,5,4,5,'Great for a casual dinner. Would love to return!','2021-02-02'),(52,1,12,5,5,5,5,5,'Delicious Lebanese food with great service. The shawarma is a must-try!','2019-06-05'),(53,2,13,5,5,5,5,5,'Outdoor seating was perfect on a summer evening. The mezza was superb!','2022-08-02'),(54,3,13,4,4,5,5,5,'Lovely experience, though a bit crowded on weekends. Great food!','2024-01-18'),(55,4,13,3,3,3,4,3,'The food was okay, but I wasn\'t impressed with the service.','2019-05-16'),(56,5,13,5,5,5,5,5,'The outdoor seating and mezza were fantastic. Perfect spot for summer evenings!','2021-07-11'),(57,6,14,5,5,5,5,4,'Amazing shawarma and incredible desserts. The staff was super friendly!','2020-09-25'),(58,7,14,4,5,4,4,5,'Great food and value for money, although it was a little noisy.','2023-10-04'),(59,8,14,5,5,5,4,5,'Perfect spot for a casual dinner. Amazing Lebanese dishes!','2021-01-25'),(60,9,14,4,5,4,5,5,'The food was excellent, but the service could have been quicker.','2018-02-16'),(61,1,15,5,5,5,5,5,'A truly exceptional dining experience. The food was exquisite, and the staff was incredibly attentive.','2022-07-12'),(62,11,15,3,4,3,5,4,'Nice location but the food was a bit bland for my liking. The service was slow too.','2021-11-15'),(63,12,15,2,3,2,4,3,'Disappointing experience. The food was cold, and the staff seemed disinterested. Not likely to return.','2023-02-03'),(64,2,15,5,5,5,5,5,'Everything was perfect! The steak was cooked to perfection, and the dessert was out of this world. Highly recommend!','2023-04-01'),(65,14,15,1,2,1,3,2,'Terrible experience. The food was undercooked, and we had to wait over an hour for our main course. Definitely not coming back.','2024-01-11'),(66,13,16,4,5,4,4,4,'Great atmosphere, but the food could have been better. Worth a visit if you are in the area.','2021-05-25'),(67,14,16,3,3,3,4,3,'Decent food, but the service was really slow and the waitstaff seemed a bit disorganized.','2023-08-17'),(68,15,16,5,5,5,5,5,'One of the best meals I’ve had in a long time. The seafood platter was phenomenal, and the service was exceptional!','2022-06-08'),(69,15,16,2,3,2,3,2,'Unfortunately, my experience was far from good. The food lacked flavor, and the service was inattentive. I won’t be returning.','2023-11-01'),(70,10,16,4,2,1,3,2,'Solid option for a night out. The food was tasty, and the location was perfect for a casual dinner with friends.','2022-02-19');
...
INSERT INTO `user` VALUES (1,'alice@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Alice','Charles'),(2,'bob@example.com','securepass','Bob','McGill'),(3,'charlie@example.com','qwerty123','Charlie','Smith'),(4,'diana@example.com','letmein456','Diana','Peterson'),(5,'edward@example.com','sunshine789','Edward','Brooks'),(6,'fay@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Fay','Davis'),(7,'george@example.com','password123','George','Taylor'),(8,'hannah@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Hannah','Wilson'),(9,'ian@example.com','letmein123','Ian','Miller'),(10,'julia@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Julia','Moore'),(11,'kyle@example.com','1234abcd','Kyle','Taylor'),(12,'lily@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Lily','White'),(13,'mike@example.com','password321','Mike','Green'),(14,'nancy@example.com','$2b$12$upvb9/A98EMVEKw/mVk5qO0rnQJW/LIV/MU/HuvxuvnzpXlij0KKm','Nancy','Adams'),(15,'oliver@example.com','mypassword2023','Oliver','King');
...
INSERT INTO `vibetype` VALUES (1,'Casual Dining'),(3,'Cosy & Intimate'),(2,'Fine Dining'),(6,'Loud & Lively'),(5,'Office Eats'),(4,'Special Occasion');
/*!40000 ALTER TABLE `vibetype` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'projectdb4'
--
...
-- Dump completed on 2025-04-25 23:26:45
